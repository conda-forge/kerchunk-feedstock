...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kerchunk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14298&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kerchunk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kerchunk` can be installed with:

```
conda install kerchunk
```

It is possible to list all of the versions of `kerchunk` available on your platform with:
